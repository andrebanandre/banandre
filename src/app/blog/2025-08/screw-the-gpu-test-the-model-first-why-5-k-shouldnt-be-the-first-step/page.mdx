...
description: >-
  You're staring at an RTX-5090 on the showroom shelf, the price tag bleeding
  into your startup's budget. The promise? 5,800 tokens/sec, 4 GB VRAM,
  "Blackwell wonder." The real question: how much of that performance will you
...
openGraph:
  ...
  description: >-
    ...
    actually get in production?
  url: >-
    https://banandre.com/blog/2025-08/screw-the-gpu-test-the-model-first-why-5-k-shouldnt-be-the-first-step
  siteName: Banandre
  images:
    - url: 'https://banandre.com/blog/2025/expensive-gpu-butning-money-llm.webp'
      width: 1200
      height: 630
      alt: 'Screw the GPU, test the model first. Why $5k shouldn''t be the first step'
...
twitter:
  ...
  description: >-
    ...
    actually get in production?
  images:
    - 'https://banandre.com/blog/2025/expensive-gpu-butning-money-llm.webp'
jsonLd:
  '@context': 'https://schema.org'
  '@type': BlogPosting
  headline: 'Screw the GPU, test the model first. Why $5k shouldn''t be the first step'
  description: >-
    You're staring at an RTX-5090 on the showroom shelf, the price tag bleeding
    into your startup's budget. The promise? 5,800 tokens/sec, 4 GB VRAM,
    "Blackwell wonder." The real question: how much of that performance will you
    actually get in production?
  image: 'https://banandre.com/blog/2025/expensive-gpu-butning-money-llm.webp'
  url: >-
    https://banandre.com/blog/2025-08/screw-the-gpu-test-the-model-first-why-5-k-shouldnt-be-the-first-step
