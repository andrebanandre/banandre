...
description: >-
  Microsoft's new open-source TTS model can synthesize feature-length audio with
  multiple speakers, but comes with audible disclaimers and watermarking to
  prevent misuse.
slug: microsofts-vibevoice-15b-can-generate-90-minute-podcasts-with-4-voices
image: >-
  /blog/2025/microsofts-vibevoice-15b-can-generate-90-minute-podcasts-with-4-voicess.webp
...
openGraph:
  ...
  title: Microsoft's VibeVoice 1.5B Can Generate 90-Minute Podcasts With 4 Voices
  description: >-
    Microsoft's new open-source TTS model can synthesize feature-length audio
    with multiple speakers, but comes with audible disclaimers and watermarking
    to prevent misuse.
  url: >-
    https://banandre.com/blog/2025-08/microsofts-vibevoice-15b-can-generate-90-minute-podcasts-with-4-voices
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/microsofts-vibevoice-15b-can-generate-90-minute-podcasts-with-4-voicess.webp
      width: 1200
      height: 630
      alt: Microsoft's VibeVoice 1.5B Can Generate 90-Minute Podcasts With 4 Voices
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: Microsoft's VibeVoice 1.5B Can Generate 90-Minute Podcasts With 4 Voices
  description: >-
    Microsoft's new open-source TTS model can synthesize feature-length audio
    with multiple speakers, but comes with audible disclaimers and watermarking
    to prevent misuse.
