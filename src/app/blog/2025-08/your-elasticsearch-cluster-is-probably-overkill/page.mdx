...
description: >-
  Instacart's move to PostgreSQL for search infrastructure reveals uncomfortable
  truths about search engine complexity versus relational database maturity.
...
openGraph:
  ...
  title: Your Elasticsearch Cluster is Probably Overkill
  description: >-
    Instacart's move to PostgreSQL for search infrastructure reveals
    uncomfortable truths about search engine complexity versus relational
    database maturity.
  url: >-
    https://banandre.com/blog/2025-08/your-elasticsearch-cluster-is-probably-overkill
  siteName: Banandre
  images:
    - url: 'https://banandre.com/blog/2025/postgres-vs-elasticsearch.webp'
      width: 1200
      height: 630
      alt: Your Elasticsearch Cluster is Probably Overkill
...
twitter:
  ...
  description: >-
    ...
    database maturity.
  images:
    - 'https://banandre.com/blog/2025/postgres-vs-elasticsearch.webp'
jsonLd:
  '@context': 'https://schema.org'
  '@type': BlogPosting
  headline: Your Elasticsearch Cluster is Probably Overkill
  description: >-
    Instacart's move to PostgreSQL for search infrastructure reveals
    uncomfortable truths about search engine complexity versus relational
    database maturity.
  image: 'https://banandre.com/blog/2025/postgres-vs-elasticsearch.webp'
  url: >-
    https://banandre.com/blog/2025-08/your-elasticsearch-cluster-is-probably-overkill
