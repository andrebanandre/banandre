...
description: "Why writing large PySpark DataFrames as JSON to S3 is fundamentally flawed - and what you should do instead"
slug: json-pyspark-performance-trap
image: "/blog/2025/json-pyspark-performance-trap.webp"
date: 2025-10-04
tags: ["pyspark", "s3", "json", "data-engineering", "performance"]
