...
description: "Apache Fluss 0.8.0 introduces Iceberg support, enabling sub-second latency processing via Flink and positioning itself as the hot layer solution for Iceberg-based lakehouses."
...
date: 2025-10-20
tags: ["flink", "iceberg", "real-time", "data-engineering", "apache-fluss", "kafka"]
