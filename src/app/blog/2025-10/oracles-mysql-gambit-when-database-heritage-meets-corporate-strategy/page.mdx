...
description: "Exploring Oracle's shifting priorities for MySQL and what it means for long-term database architecture decisions in the open source landscape."
slug: oracles-mysql-gambit-when-database-heritage-meets-corporate-strategy
image: "/blog/2025/oracles-mysql-gambit-when-database-heritage-meets-corporate-strategy.webp"
date: 2025-10-13
tags: ["mysql", "mariadb", "oracle", "database", "open-source"]
