...
description: >-
  The Model Context Protocol is the de facto API for AI agents,  but most teams
  are securing it like a REST endpoint. Here's why that's a catastrophic
  mistake.
...
openGraph:
  ...
  title: 'MCP Is the New Attack Surface,  And Your AI Agents Are Barefoot'
  description: >-
    The Model Context Protocol is the de facto API for AI agents,  but most
    teams are securing it like a REST endpoint. Here's why that's a catastrophic
    mistake.
  url: >-
    https://banandre.com/blog/2025-09/mcp-is-the-new-attack-surface-and-your-ai-agents-are-barefoot
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/mcp-is-the-new-attack-surface-and-your-ai-agents-are-barefoot.webp
      width: 1200
      height: 630
      alt: 'MCP Is the New Attack Surface,  And Your AI Agents Are Barefoot'
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: 'MCP Is the New Attack Surface,  And Your AI Agents Are Barefoot'
  description: >-
    The Model Context Protocol is the de facto API for AI agents,  but most
    teams are securing it like a REST endpoint. Here's why that's a catastrophic
    mistake.
