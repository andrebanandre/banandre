...
description: >-
  The brutal CAP theorem tradeoffs between AWS SNS/SQS and custom event services
...
openGraph:
  ...
  title: SNS vs Dedicated Services. CAP theorem tradeoffs
  description: >-
    The brutal CAP theorem tradeoffs between AWS SNS/SQS and custom event
    services that nobody talks about
  url: >-
    https://banandre.com/blog/2025-09/sns-vs-dedicated-event-service-cap-theorem-tradeoffs
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/sns-vs-dedicated-event-service-cap-theorem-tradeoffs.webp
      width: 1200
      height: 630
      alt: SNS vs Dedicated Services. CAP theorem tradeoffs
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: SNS vs Dedicated Services. CAP theorem tradeoffs
  description: >-
    The brutal CAP theorem tradeoffs between AWS SNS/SQS and custom event
    services that nobody talks about
  image: >-
...
![PACEL extension of CAP](/blog/2025/cap-pacelc-extension.webp)
