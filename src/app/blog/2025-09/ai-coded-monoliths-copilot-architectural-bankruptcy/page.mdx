...
description: >-
  Generative coding tools boost velocity while quietly eroding software
  architecture, creating monoliths faster than ever before. The data reveals a
  paradox: more code, more technical debt.
...
openGraph:
  ...
  description: >-
    ...
    paradox: more code, more technical debt.
  url: >-
    https://banandre.com/blog/2025-09/ai-coded-monoliths-copilot-architectural-bankruptcy
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/ai-coded-monoliths-copilot-architectural-bankruptcy.webp
      width: 1200
      height: 630
      alt: 'AI-Coded Monoliths: How Copilot Accelerates Architectural Bankruptcy'
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: 'AI-Coded Monoliths: How Copilot Accelerates Architectural Bankruptcy'
  description: >-
    Generative coding tools boost velocity while quietly eroding software
    architecture, creating monoliths faster than ever before. The data reveals a
    paradox: more code, more technical debt.
