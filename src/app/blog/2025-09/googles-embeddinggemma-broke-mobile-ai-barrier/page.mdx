...
description: >-
  Google's new 300M parameter embedding model delivers enterprise-grade
  performance on consumer hardware, threatening cloud dominance
...
openGraph:
  ...
  description: >-
    ...
    performance on consumer hardware, threatening cloud dominance
  url: >-
    https://banandre.com/blog/2025-09/googles-embeddinggemma-broke-mobile-ai-barrier
  siteName: Banandre
  images:
    - url: 'https://banandre.com/blog/2025/embeddinggemma-mobile-ai-revolution.webp'
      width: 1200
      height: 630
      alt: Google's EmbeddingGemma Just Broke the Mobile AI Barrier
...
twitter:
  ...
  description: >-
    ...
    performance on consumer hardware, threatening cloud dominance
  images:
    - 'https://banandre.com/blog/2025/embeddinggemma-mobile-ai-revolution.webp'
jsonLd:
  '@context': 'https://schema.org'
  '@type': BlogPosting
  headline: Google's EmbeddingGemma Just Broke the Mobile AI Barrier
  description: >-
    Google's new 300M parameter embedding model delivers enterprise-grade
    performance on consumer hardware, threatening cloud dominance
  image: 'https://banandre.com/blog/2025/embeddinggemma-mobile-ai-revolution.webp'
  url: >-
    https://banandre.com/blog/2025-09/googles-embeddinggemma-broke-mobile-ai-barrier
...
![MTEB Score](/blog/2025/gemma-emending-benchmarks.webp)
...
![MTEB Multilingual v2](/blog/2025/gemma-mteb-scale.webp)
