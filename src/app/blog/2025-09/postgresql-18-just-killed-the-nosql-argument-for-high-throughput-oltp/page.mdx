...
description: >-
  With 3,057 TPS and 5.2ms latency, PostgreSQL 18 isn't just catching up to
  NoSQL systems, it's redefining what a relational database can do under load.
slug: postgresql-18-just-killed-the-nosql-argument-for-high-throughput-oltp
image: >-
  /blog/2025/postgresql-18-just-killed-the-nosql-argument-for-high-throughput-oltp.webp
...
openGraph:
  ...
  description: >-
    ...
    NoSQL systems, it's redefining what a relational database can do under load.
  url: >-
    https://banandre.com/blog/2025-09/postgresql-18-just-killed-the-nosql-argument-for-high-throughput-oltp
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/postgresql-18-just-killed-the-nosql-argument-for-high-throughput-oltp.webp
      width: 1200
      height: 630
      alt: PostgreSQL 18 Just Killed the NoSQL Argument for High-Throughput OLTP
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: PostgreSQL 18 Just Killed the NoSQL Argument for High-Throughput OLTP
  description: >-
    With 3,057 TPS and 5.2ms latency, PostgreSQL 18 isn't just catching up to
    NoSQL systems, it's redefining what a relational database can do under load.
  image: >-
