...
description: >-
  How API-first principles backfire when developers forget who actually uses
  their interfaces
...
openGraph:
  ...
  description: >-
    How API-first principles backfire when developers forget who actually uses
    their interfaces
  url: 'https://banandre.com/blog/2025-09/api-first-design-the-consumer-last-trap'
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/api-first-design-consumer-last-dilemma.webp
      width: 1200
      height: 630
      alt: 'API-First Design: The Consumer-Last Trap'
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: 'API-First Design: The Consumer-Last Trap'
  description: >-
    How API-first principles backfire when developers forget who actually uses
    their interfaces
  image: 'https://banandre.com/blog/2025/api-first-design-consumer-last-dilemma.webp'
  url: 'https://banandre.com/blog/2025-09/api-first-design-the-consumer-last-trap'
  ...
  mainEntityOfPage:
    '@type': WebPage
    '@id': 'https://banandre.com/blog/2025-09/api-first-design-the-consumer-last-trap'
---
