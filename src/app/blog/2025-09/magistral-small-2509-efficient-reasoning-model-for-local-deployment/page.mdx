...
description: "Mistral's 24B parameter reasoning model runs on a single RTX 4090, delivers GPT-4 level performance, and costs exactly zero dollars per token."
slug: magistral-small-2509-efficient-reasoning-model-for-local-deployment
image: "/blog/2025/magistral-small-2509-efficient-reasoning-model-for-local-deployment.webp"
date: 2025-09-18
tags: ["AI", "ML", "LocalAI", "Mistral"]
