...
description: "New framework turns BERT into a diffusion-based chatbot using discrete diffusion, and it's rewriting how we think about language generation"
slug: diffusion-language-models-are-breaking-the-autoregressive-dungeon
image: "/blog/2025/diffusion-language-models-are-breaking-the-autoregressive-dungeon.gif"
date: 2025-11-10
tags: ["diffusion", "language-models", "BERT", "nlp", "natural-language-processing"]
