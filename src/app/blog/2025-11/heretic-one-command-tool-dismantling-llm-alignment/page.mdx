...
description: >-
  A technical and ethical analysis of Heretic, an open-source tool that
  automatically removes censorship from language models in a single command.
slug: heretic-one-command-tool-dismantling-llm-alignment
image: >-
  /blog/2025/heretic-fully-automatic-censorship-removal-for-llms-sparks-ethical-and-technical-debate_cdn-media.png
...
openGraph:
  ...
  description: >-
    ...
    automatically removes censorship from language models in a single command.
  url: >-
    https://banandre.com/blog/2025-11/heretic-one-command-tool-dismantling-llm-alignment
  siteName: Banandre
  images:
    - url: >-
        https://banandre.com/blog/2025/heretic-fully-automatic-censorship-removal-for-llms-sparks-ethical-and-technical-debate_cdn-media.png
      width: 1200
      height: 630
      alt: 'Heretic: The One-Command Tool Dismantling LLM Alignment'
...
jsonLd:
  ...
  '@type': BlogPosting
  headline: 'Heretic: The One-Command Tool Dismantling LLM Alignment'
  description: >-
    A technical and ethical analysis of Heretic, an open-source tool that
    automatically removes censorship from language models in a single command.
  image: >-
