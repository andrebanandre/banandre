  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="prose prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <div className="bg-[var(--muted)] border-2 border-[var(--accent)] p-6 rounded space-y-4">
            <div>
              ...
              <p className="text-gray-300">Andrii Fedorenko</p>
            </div>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-wide">Contact</h2>
        ...
        <section>
          ...
          <p className="text-gray-300">
            Responsible for content according to § 55 Abs. 2 RStV (German Interstate Broadcasting
            Treaty):
          </p>
          <div className="bg-[var(--muted)] border-2 border-[var(--accent)] p-6 rounded mt-4">
            <p className="text-gray-300">
              <strong className="text-white">Andrii Fedorenko</strong>
              <br />
              Contact:{" "}
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-wide">Disclaimer</h2>

          <h3 className="text-xl font-semibold text-[var(--accent)] mb-3">Liability for Content</h3>
          <p className="text-gray-300 mb-4">
            The contents of our pages were created with great care. However, we cannot guarantee
            that the content is accurate, complete, or up-to-date. As a service provider, we are
            responsible for our own content on these pages in accordance with general law pursuant
            to § 7 (1) TMG. However, according to §§ 8 to 10 TMG, we are not obligated as a service
            provider to monitor transmitted or stored third-party information or to investigate
            circumstances that indicate illegal activity.
          </p>
          <p className="text-gray-300 mb-6">
            Obligations to remove or block the use of information in accordance with general law
            remain unaffected. However, liability in this regard is only possible from the time of
            knowledge of a specific infringement. Upon becoming aware of corresponding legal
            violations, we will remove this content immediately.
          </p>

          <h3 className="text-xl font-semibold text-[var(--accent)] mb-3">Liability for Links</h3>
          <p className="text-gray-300 mb-4">
            Our website contains links to external third-party websites over whose content we have
            no control. Therefore, we cannot accept any liability for this external content. The
          ...
          <p className="text-gray-300 mb-6">
            ...
            evidence of an infringement. Upon becoming aware of legal violations, we will remove
            such links immediately.
          </p>

          <h3 className="text-xl font-semibold text-[var(--accent)] mb-3">Copyright</h3>
          <p className="text-gray-300 mb-4">
        ...
        <section className="mt-12 pt-8 border-t-2 border-gray-700">
          ...
          <p className="text-gray-300 mb-4">
            ...
            <strong className="text-white">Andrii Fedorenko</strong>, a software developer and
            technology writer. The blog focuses on artificial intelligence, software architecture,
            and technology insights.
          </p>
          <p className="text-gray-300">
            <strong className="text-white">Professional Background:</strong> Software Developer &
            Technology Writer
            <br />
            <strong className="text-white">Topics:</strong> Artificial Intelligence, Machine
            Learning, Software Development, Technology Analysis, Engineering Management
          </p>
        </section>
        ...
        <section className="mt-8 pt-8 border-t-2 border-gray-700">
          ...
          <p className="text-gray-300 mb-4">
            In the spirit of transparency: some content on this blog is created with the assistance
            of artificial intelligence (AI) tools.
          </p>
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
            <li>
              <strong className="text-white">AI as a writing tool:</strong> We use AI to help draft,
              research, and structure content
            </li>
            <li>
              <strong className="text-white">Human oversight:</strong> Content is reviewed by a
              human before publication
            </li>
            <li>
              <strong className="text-white">No perfection guaranteed:</strong> Despite our efforts,
              AI-assisted content may contain errors or inaccuracies
            </li>
          </ul>
          <p className="text-gray-300 mb-4">
            <strong className="text-white">Our approach:</strong> AI enables us to cover more topics
            and produce content more efficiently. We view it as a productivity tool, similar to
            using spell-checkers or research assistants.
          </p>
          <p className="text-gray-300">
            <strong className="text-white">Feedback welcome:</strong> If you notice errors or have
            concerns, feel free to reach out at{" "}
            <a href="mailto:andre@banandre.com" className="text-[var(--accent)] hover:underline">
              andre@banandre.com
            </a>
            . We&apos;ll do our best to address issues promptly.
          </p>
        </section>

        <section className="mt-8 pt-8 border-t-2 border-gray-700">
          <p className="text-gray-400 text-sm">
            <strong>Note:</strong> This website is operated as a personal blog. This impressum
            complies with German legal requirements (§ 5 TMG and § 55 RStV) for informational
            purposes.
          </p>
          <p className="text-gray-400 text-sm mt-2">Last updated: December 3, 2025</p>
        </section>
      </div>
    </div>
  );
