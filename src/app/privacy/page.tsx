      ...
      <div className="prose prose-invert max-w-none space-y-8">
        ...
        <section>
          <p className="text-gray-300 leading-relaxed">
            Banandre (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) is committed to protecting
        ...
        <section>
          ...
          <p className="text-gray-300 mb-4">
            ...
            analyze website traffic. See the &quot;Cookies&quot; section below for more details.
          </p>
        </section>
        ...
        <section>
          ...
          <h3 className="text-xl font-semibold text-[var(--accent)] mb-3">3.1 Google Analytics</h3>
          <p className="text-gray-300 mb-4">
            We use Google Analytics, a web analytics service provided by Google LLC
            (&quot;Google&quot;), to help us understand how visitors use our website. Google
          ...
          <p className="text-gray-300 mb-4">
            Google uses this information to provide us with reports about website activity. Google
            may also transfer this information to third parties where required by law or where such
          ...
          <p className="text-gray-300 mb-4">
            Our website is hosted on Cloudflare Workers, a serverless computing platform provided by
            Cloudflare, Inc. Cloudflare processes data on our behalf to deliver and secure our
          ...
          <p className="text-gray-300 mb-4">
            Cloudflare&apos;s observability features collect anonymized and aggregated data to
            improve service quality and detect security threats. We control the sampling rate of
            logs and what information is collected.
          </p>
          <p className="text-gray-300">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-wide">4. Cookies</h2>
          <p className="text-gray-300 mb-4">
            Cookies are small text files that are placed on your device to help us provide a better
            user experience. We use the following types of cookies:
          </p>

          <h3 className="text-xl font-semibold text-[var(--accent)] mb-3">4.1 Analytics Cookies</h3>
          <p className="text-gray-300 mb-4">
            These cookies help us understand how visitors interact with our website by collecting
            and reporting information anonymously. We use Google Analytics cookies (_ga, _gid, _gat)
            to:
          </p>
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
          ...
          <h3 className="text-xl font-semibold text-[var(--accent)] mb-3">4.2 Managing Cookies</h3>
          <p className="text-gray-300 mb-4">
          ...
          <p className="text-gray-300">
            Please note that blocking or deleting cookies may impact your user experience and some
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
            ...
            <li>
              Data is stored securely on Cloudflare&apos;s infrastructure with encryption at rest
            </li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Google Analytics data:</strong> 26 months (default setting)
            </li>
            <li>
              <strong>Cloudflare logs:</strong> As configured in our observability settings,
              typically 30 days for detailed logs
            </li>
            <li>
              <strong>Aggregated analytics:</strong> Indefinitely for historical analysis and
              reporting
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
            ...
            <li>
              ...
              any information you believe is inaccurate or complete information you believe is
              incomplete
            </li>
            <li>
          ...
          <p className="text-gray-300">
            If you make a request, we have one month to respond to you. To exercise any of these
            rights, please contact us using the information provided in the &quot;Contact Us&quot;
            section below.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2 mb-4">
            ...
            <li>
              The right to say no to the sale of personal information (we do not sell personal
              information)
            </li>
        ...
        <section>
          ...
          <p className="text-gray-300">
            ...
            may differ. We ensure appropriate safeguards are in place when transferring data
            internationally, including using services that comply with applicable data protection
            frameworks.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Legitimate interests:</strong> We process analytics data based on our
              legitimate interest in understanding how our website is used and improving our
              services
            </li>
            <li>
              <strong>Consent:</strong> Where required by law, we obtain your consent for specific
              data processing activities, such as the use of analytics cookies
            </li>
            <li>
              <strong>Legal obligation:</strong> We may process your data where necessary to comply
        ...
        <section>
          ...
          <p className="text-gray-300 mb-4">
            ...
            would like to make a request regarding your personal data, please contact us:
          </p>
        ...
        <section>
          ...
          <p className="text-gray-300 mb-4">
            If you are located in the EEA and believe we have not addressed your concerns
            adequately, you have the right to lodge a complaint with your local data protection
        ...
        <section className="mt-12 pt-8 border-t-2 border-gray-700">
          <p className="text-gray-400 text-sm">
            This privacy policy was last updated on December 3, 2025. We review and may update this
            policy periodically to reflect changes in our practices or applicable law.
          </p>
        </section>
      </div>
    </div>
