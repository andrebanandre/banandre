          ...
          <motion.div className="space-y-6" variants={itemVariants}>
            ...
            >
              ...
              <div className="flex space-x-2">
                ...
                />
                <motion.button
                  className="px-4 py-2 bg-[var(--accent)] text-[var(--accent-foreground)] font-bold text-sm uppercase hover:bg-[var(--accent-hover)] transition-colors duration-200 rounded-md"
