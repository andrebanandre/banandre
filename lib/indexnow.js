...
function parseSitemap(xmlData: string): Promise<any> {
  return new Promise((resolve, reject) => {
...
function isSitemapIndex(sitemap: any): boolean {
  return sitemap.sitemapindex !== undefined;
}

async function fetchAllUrlsFromSitemapIndex(sitemapIndex: any): Promise<UrlEntry[]> {
